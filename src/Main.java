...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos de " + devEder.getNome()+": " + devEder.getConteudosInscritos());
        devEder.progredir();
        devEder.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos de "+ devEder.getNome()+": " + devEder.getConteudosInscritos());
        System.out.println("Conteúdos Concluídos de "+ devEder.getNome()+": " + devEder.getConteudosConcluidos());
